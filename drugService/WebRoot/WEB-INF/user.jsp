								    ...
								    <thead>
								      <tr>
								        ...
								        <th width="5%" >用户ID</th>
				                          ...
				                          <th width="5%">用户性别</th>
				                          <th width="5%">用户电话</th>
				                          <th width="5%">用户email</th>
				                          <th width="5%">用户数值权限</th>
								      </tr> 
								    </thead>
								    <tbody>								      		 								       
				...
				success:function(result){
					...
					for(var i=0;i<result.length;i++){
						var tr="<tr> <td><input type='checkbox' name='' lay-skin='primary'></td>";
							tr+="<td>"+result[i].user_id+"</td>";
	                        tr+="<td>"+result[i].user_name+"</td>";
	                        tr+="<td>"+result[i].user_passwd+"</td>";
	                        tr+= "<td>"+result[i].user_sex+"</td>"; 
	                        tr+= "<td>"+result[i].user_phone+"</td>" ;
	                        tr+= "<td>"+result[i].user_email+"</td>" ;
	                        tr+=  "<td>"+result[i].numLim+"</td>";
							tr+="</tr>";
							newData+=tr;
						}
						$tbody.html(newData);
