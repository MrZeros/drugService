        ...
        <div class="">
        	 <div class="page-title">							 	
	              <div class="title_left">	              	
	              	<h3>   
	              		<a href="javascript:void(0)" class="css_btn_class">新增</a>
              ...
              <div class="x_content">
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    仓库状态 <select id="heard" class="form-control" required>
								    ...
								    <thead>
								      <tr>
								        ...
								        <th width="5%" >仓库编号</th>
				                          <th width="5%">仓库状态</th>
				                          <th width="5%">仓库容量</th>
				                          <th width="5%">仓库已用容量</th>
				                          <th width="5%">仓库可用容量</th>
				                          <th width="5%">仓库启用时间</th>
								      </tr> 
								    </thead>
								    <tbody>								      		 								       
	...
	<script type="text/javascript">
		...
		$(function(){
			$(".pagination").on("click",'a',function(){
				...
				var cmd={"status":status,"search":search,"page":currPage};
				$.ajax({
				type:"post",
				datatype:"json",
				contentType: "application/json; charset=utf-8", 
				url:"repostoryData.do",
				...
				success:function(result){
					...
					for(var i=0;i<result.length;i++){
						var tr="<tr> <td><input type='checkbox' name='' lay-skin='primary'></td>";
							tr+="<td>"+result[i].repo_id+"</td>";
	                        tr+="<td>"+result[i].repo_status+"</td>";
	                        tr+="<td>"+result[i].repo_capacity+"</td>";
	                        tr+= "<td>"+result[i].repo_position+"</td>"; 
	                        tr+= "<td>"+result[i].repo_avai+"</td>" ;
			...
			$("#go").click(function(){
				var status=$("#heard").val();
				var search=$("#search").val();
				var cmd={"status":status,"search":search,"page":"1"};
				$.ajax({
				type:"post",
				datatype:"json",
				contentType: "application/json; charset=utf-8", 
