	...
	<script type="text/javascript">
		...
		$(function(){
			$(".pagination").on("click",'a',function(){
				...
				var cmd={"startDate":startDate,"endDate":endDate,"page":currPage,"search":search};
				$.ajax({
				type:"post",
				datatype:"json",
				...
				success:function(result){
					...
					for(var i=0;i<result.length;i++){
						var tr="<tr> <td><input type='checkbox' name='' lay-skin='primary'></td>";
							tr+="<td>"+result[i].sale_no+"</td>";
	                        tr+="<td>"+result[i].drg_no+"</td>";
	                        tr+="<td>"+result[i].repo_no+"</td>";
	                        tr+= "<td>"+result[i].repo_local+"</td>"; 
	                        tr+= "<td>"+result[i].drg_name+"</td>" ;
	                        tr+= "<td>"+result[i].sale_num+"</td>" ;
	                        tr+=  "<td>"+result[i].sale_money+"</td>";
	                        tr+=  "<td>"+result[i].drg_price+"</td>";
	                        tr+= "<td>"+result[i].sale_operator+"</td>" ;
	                        tr+= "<td>"+result[i].sale_date+"</td>" ;
	                        tr+=  "<td>"+result[i].user_name+"</td>";
	                        tr+=  "<td>"+result[i].user_addr+"</td>";
							tr+="</tr>";
							newData+=tr;
						}
						$tbody.html(newData);
			...
			$("#go").click(function(){
				...
				var cmd={"startDate":startDate,"endDate":endDate,"page":"1","search":search};
				$.ajax({
				type:"post",
				datatype:"json",
				contentType: "application/json; charset=utf-8", 
