								    ...
								    <thead>
								      <tr>
								        ...
								        <th width="20%" >功能ID</th>
				                          ...
				                          <th width="20%">功能事件</th>
				                          <th width="20%">功能图标</th>
				                          <th width="20%">父级功能ID</th>
								      </tr> 
								    </thead>
								    <tbody>								      		 								       
								     	  <c:forEach items="${allFuncs }" var="func">
								     	  	<tr>
				...
				success:function(result){
					...
					for(var i=0;i<result.length;i++){
						var tr="<tr> <td><input type='checkbox' name='' lay-skin='primary'></td>";
							tr+="<td>"+result[i].func_id+"</td>";
	                        tr+="<td>"+result[i].func_name+"</td>";
	                        tr+="<td>"+result[i].action+"</td>";
	                        tr+= "<td>"+result[i].icon+"</td>"; 
	                        tr+= "<td>"+result[i].parent_func_id+"</td>";
							tr+="</tr>";
							newData+=tr;
						}
						$tbody.html(newData);
